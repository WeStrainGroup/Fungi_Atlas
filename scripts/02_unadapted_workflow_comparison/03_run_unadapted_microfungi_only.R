#!/usr/bin/env Rscript
# Purpose: Run the fixed-trimming DADA2 workflow with all-eukaryote taxonomy and MycoGAP-style microfungal filtering.
...
# path_out <- "/data/wangxinyu/Fungi_Atlas/Analysis/Q_ITS_Error/Annotation/unadapted2/WeP1"
# pattern_F <- ".1.fq.gz"
# pattern_R <- ".2.fq.gz"
...
# path_out <- "/data/wangxinyu/Fungi_Atlas/Analysis/Q_ITS_Error/Annotation/unadapted2/HMP"
...
path_out <- "/data/wangxinyu/Fungi_Atlas/Analysis/Q_ITS_Error/Annotation/unadapted2/CHGM"
pattern_F <- ".1.fastq.gz"
pattern_R <- ".2.fastq.gz"
...
ref <- "/data/wangxinyu/Ref/ITS_anno/Unite/sh_general_release_all_19.02.2025/sh_general_release_dynamic_all_19.02.2025.fasta"
minBoot <- 50
...
microbiome::summarize_phyloseq(ps_microfungi)
...
ps_microfungi2 <- prune_taxa(!(taxa_names(ps_microfungi) %in% ASV_to_drop), ps_microfungi)

# Check
ntaxa(ps_microfungi)
ntaxa(ps_microfungi2)
microbiome::summarize_phyloseq(ps_microfungi2)
...
write.csv(readcount(ps_microfungi2), file.path(path_microfungi_ASV, paste0(project, "readcount_microfungi.csv")))
...
# Alpha diversity
try({diversity_microfungi <- estimate_richness(ps_microfungi2, split = TRUE, measures = c("Observed", "Shannon", "Simpson"))
...
ps_microfungi_gen_p0 <- aggregate_taxa(ps_microfungi2, level = "Genus")
ps_microfungi_gen_p1 <- aggregate_rare(ps_microfungi2, level = "Genus", detection = 0, prevalence = 1/100)
ps_microfungi_gen_p5 <- aggregate_rare(ps_microfungi2, level = "Genus", detection = 0, prevalence = 5/100)
ps_microfungi_gen_p10 <- aggregate_rare(ps_microfungi2, level = "Genus", detection = 0, prevalence = 10/100)

otu_gen_p0_clr <- vegan::decostand(ps_microfungi_gen_p0@otu_table, MARGIN = 2, method = "clr", pseudocount = 1)
otu_gen_p1_clr <- vegan::decostand(ps_microfungi_gen_p1@otu_table, MARGIN = 2, method = "clr", pseudocount = 1)
otu_gen_p5_clr <- vegan::decostand(ps_microfungi_gen_p5@otu_table, MARGIN = 2, method = "clr", pseudocount = 1)
otu_gen_p10_clr <- vegan::decostand(ps_microfungi_gen_p10@otu_table, MARGIN = 2, method = "clr", pseudocount = 1)

write.csv(ps_microfungi_gen_p0@tax_table, file.path(path_microfungi_gen, paste0(project,"taxa_microfungi_gen.csv")))
write.csv(ps_microfungi_gen_p0@otu_table, file.path(path_microfungi_gen, paste0(project,"otu_microfungi_gen_p0.csv")))
write.csv(ps_microfungi_gen_p1@otu_table, file.path(path_microfungi_gen, paste0(project,"otu_microfungi_gen_p1.csv")))
write.csv(ps_microfungi_gen_p5@otu_table, file.path(path_microfungi_gen, paste0(project,"otu_microfungi_gen_p5.csv")))
write.csv(ps_microfungi_gen_p10@otu_table, file.path(path_microfungi_gen, paste0(project,"otu_microfungi_gen_p10.csv")))

write.csv(otu_gen_p0_clr, file.path(path_microfungi_gen, paste0(project,"otu_microfungi_gen_p0_clr.csv")))
write.csv(otu_gen_p1_clr, file.path(path_microfungi_gen, paste0(project,"otu_microfungi_gen_p1_clr.csv")))
write.csv(otu_gen_p5_clr, file.path(path_microfungi_gen, paste0(project,"otu_microfungi_gen_p5_clr.csv")))
write.csv(otu_gen_p10_clr, file.path(path_microfungi_gen, paste0(project,"otu_microfungi_gen_p10_clr.csv")))
...
ps_microfungi_phy_p0 <- aggregate_taxa(ps_microfungi2, level = "Phylum")
ps_microfungi_phy_p1 <- aggregate_rare(ps_microfungi2, level = "Phylum", detection = 0, prevalence = 1/100)
ps_microfungi_phy_p5 <- aggregate_rare(ps_microfungi2, level = "Phylum", detection = 0, prevalence = 5/100)
ps_microfungi_phy_p10 <- aggregate_rare(ps_microfungi2, level = "Phylum", detection = 0, prevalence = 10/100)

otu_phy_p0_clr <- vegan::decostand(ps_microfungi_phy_p0@otu_table, MARGIN = 2, method = "clr", pseudocount = 1)
otu_phy_p1_clr <- vegan::decostand(ps_microfungi_phy_p1@otu_table, MARGIN = 2, method = "clr", pseudocount = 1)
otu_phy_p5_clr <- vegan::decostand(ps_microfungi_phy_p5@otu_table, MARGIN = 2, method = "clr", pseudocount = 1)
otu_phy_p10_clr <- vegan::decostand(ps_microfungi_phy_p10@otu_table, MARGIN = 2, method = "clr", pseudocount = 1)

write.csv(ps_microfungi_phy_p0@tax_table, file.path(path_microfungi_phy, paste0(project,"taxa_microfungi_phy.csv")))
write.csv(ps_microfungi_phy_p0@otu_table, file.path(path_microfungi_phy, paste0(project,"otu_microfungi_phy_p0.csv")))
write.csv(ps_microfungi_phy_p1@otu_table, file.path(path_microfungi_phy, paste0(project,"otu_microfungi_phy_p1.csv")))
write.csv(ps_microfungi_phy_p5@otu_table, file.path(path_microfungi_phy, paste0(project,"otu_microfungi_phy_p5.csv")))
write.csv(ps_microfungi_phy_p10@otu_table, file.path(path_microfungi_phy, paste0(project,"otu_microfungi_phy_p10.csv")))

write.csv(otu_phy_p0_clr, file.path(path_microfungi_phy, paste0(project,"otu_microfungi_phy_p0_clr.csv")))
write.csv(otu_phy_p1_clr, file.path(path_microfungi_phy, paste0(project,"otu_microfungi_phy_p1_clr.csv")))
write.csv(otu_phy_p5_clr, file.path(path_microfungi_phy, paste0(project,"otu_microfungi_phy_p5_clr.csv")))
write.csv(otu_phy_p10_clr, file.path(path_microfungi_phy, paste0(project,"otu_microfungi_phy_p10_clr.csv")))

# --- 3.2.3 Write output with read depth filteration  ---
# Remove samples with insufficient reads
ps_microfungi3 <- prune_samples(sample_sums(ps_microfungi2) >= filter_depth, ps_microfungi2)
ps_microfungi3 <- filter_taxa(ps_microfungi3, function(otu) sum(otu) > 1, TRUE) # Remove ASVs that are all zeros after filtering

# Check
ntaxa(ps_microfungi2)
ntaxa(ps_microfungi3)
nsamples(ps_microfungi2)
nsamples(ps_microfungi3)
microbiome::summarize_phyloseq(ps_microfungi3)
...
saveRDS(ps_microfungi3, file.path(path_microfungi_ASV, paste0(project, "ps_microfungi_filterdp.rds")))
write.csv(readcount(ps_microfungi3), file.path(path_microfungi_ASV, paste0(project, "readcount_microfungi_filterdp.csv")))
write.csv(ps_microfungi3@tax_table, file.path(path_microfungi_ASV, paste0(project, "taxa_microfungi_filterdp.csv")))
write.csv(ps_microfungi3@otu_table, file.path(path_microfungi_ASV, paste0(project,"otu_microfungi_filterdp.csv")))

# Alpha diversity
try({diversity_microfungi_filterdp <- estimate_richness(ps_microfungi3, split = TRUE, measures = c("Observed", "Shannon", "Simpson"))
     write.csv(diversity_microfungi_filterdp, file.path(path_microfungi_ASV, paste0(project, "diversity_microfungi_filterdp.csv")))
     })
...
ps_microfungi_gen_p0 <- aggregate_taxa(ps_microfungi3, level = "Genus")
ps_microfungi_gen_p1 <- aggregate_rare(ps_microfungi3, level = "Genus", detection = 0, prevalence = 1/100)
ps_microfungi_gen_p5 <- aggregate_rare(ps_microfungi3, level = "Genus", detection = 0, prevalence = 5/100)
ps_microfungi_gen_p10 <- aggregate_rare(ps_microfungi3, level = "Genus", detection = 0, prevalence = 10/100)
...
write.csv(ps_microfungi_gen_p0@tax_table, file.path(path_microfungi_gen, paste0(project,"taxa_microfungi_gen_filterdp.csv")))
write.csv(ps_microfungi_gen_p0@otu_table, file.path(path_microfungi_gen, paste0(project,"otu_microfungi_gen_p0_filterdp.csv")))
write.csv(ps_microfungi_gen_p1@otu_table, file.path(path_microfungi_gen, paste0(project,"otu_microfungi_gen_p1_filterdp.csv")))
write.csv(ps_microfungi_gen_p5@otu_table, file.path(path_microfungi_gen, paste0(project,"otu_microfungi_gen_p5_filterdp.csv")))
write.csv(ps_microfungi_gen_p10@otu_table, file.path(path_microfungi_gen, paste0(project,"otu_microfungi_gen_p10_filterdp.csv")))

write.csv(otu_gen_p0_clr, file.path(path_microfungi_gen, paste0(project,"otu_microfungi_gen_p0_clr_filterdp.csv")))
write.csv(otu_gen_p1_clr, file.path(path_microfungi_gen, paste0(project,"otu_microfungi_gen_p1_clr_filterdp.csv")))
write.csv(otu_gen_p5_clr, file.path(path_microfungi_gen, paste0(project,"otu_microfungi_gen_p5_clr_filterdp.csv")))
write.csv(otu_gen_p10_clr, file.path(path_microfungi_gen, paste0(project,"otu_microfungi_gen_p10_clr_filterdp.csv")))
...
ps_microfungi_phy_p0 <- aggregate_taxa(ps_microfungi3, level = "Phylum")
ps_microfungi_phy_p1 <- aggregate_rare(ps_microfungi3, level = "Phylum", detection = 0, prevalence = 1/100)
ps_microfungi_phy_p5 <- aggregate_rare(ps_microfungi3, level = "Phylum", detection = 0, prevalence = 5/100)
ps_microfungi_phy_p10 <- aggregate_rare(ps_microfungi3, level = "Phylum", detection = 0, prevalence = 10/100)
...
write.csv(ps_microfungi_phy_p0@tax_table, file.path(path_microfungi_phy, paste0(project,"taxa_microfungi_phy_filterdp.csv")))
write.csv(ps_microfungi_phy_p0@otu_table, file.path(path_microfungi_phy, paste0(project,"otu_microfungi_phy_p0_filterdp.csv")))
write.csv(ps_microfungi_phy_p1@otu_table, file.path(path_microfungi_phy, paste0(project,"otu_microfungi_phy_p1_filterdp.csv")))
write.csv(ps_microfungi_phy_p5@otu_table, file.path(path_microfungi_phy, paste0(project,"otu_microfungi_phy_p5_filterdp.csv")))
write.csv(ps_microfungi_phy_p10@otu_table, file.path(path_microfungi_phy, paste0(project,"otu_microfungi_phy_p10_filterdp.csv")))

write.csv(otu_phy_p0_clr, file.path(path_microfungi_phy, paste0(project,"otu_microfungi_phy_p0_clr_filterdp.csv")))
write.csv(otu_phy_p1_clr, file.path(path_microfungi_phy, paste0(project,"otu_microfungi_phy_p1_clr_filterdp.csv")))
write.csv(otu_phy_p5_clr, file.path(path_microfungi_phy, paste0(project,"otu_microfungi_phy_p5_clr_filterdp.csv")))
write.csv(otu_phy_p10_clr, file.path(path_microfungi_phy, paste0(project,"otu_microfungi_phy_p10_clr_filterdp.csv")))
...
try <- try({ps_mushroom <- prune_taxa((taxa_names(ps_microfungi) %in% ASV_to_drop), ps_microfungi)})
...
if (inherits(try, "try-error")) {
  message("Note: No mushroom reads were detected for analysis\n")
    ...
    saveRDS(ps_mushroom, file.path(path_mushroom_ASV, paste0(project, "ps_mushroom.rds")))
